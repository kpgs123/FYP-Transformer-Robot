...
# Error and integral term for the PI controller
error_sum = 0
...
def move_robot_to_coordinates(x, y):
    ...
    # Calculate error for the PI controller
    ...
    # Apply the PI controller to calculate the vertical movement command
    command += str(round(k_p * (error_x + error_y) + k_i * error_sum))
