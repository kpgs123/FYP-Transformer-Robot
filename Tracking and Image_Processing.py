...
cap = cv2.VideoCapture("E:/sem 7-------------/Final Year Design Project/Git/FYP-Transformer-Robot/FYP Videos/2_res_Trim.mp4")
...
th1 = threading.Thread(target=Image_processing, args=(img, ))
th2 = threading.Thread(target=Object_Tracking, args=(cap, )) 
th1.start()  
th2.start()  
th1.join()  
th2.join()
