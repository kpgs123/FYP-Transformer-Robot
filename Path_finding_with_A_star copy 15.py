...
try:
    ...
    while True:
        ...
        if current_time - last_frame_time >= frame_interval:
            ...
            if len(corners) > 0:
                ...
                cv.putText(cropped_frame, f"Rotation: {z_rot}", (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 250, 0), 2)
                ...
                cv.putText(cropped_frame, f"position: {centroid}", (10,100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 250, 0), 2)
    ...
    if cv.getWindowProperty('frame', cv2.WND_PROP_VISIBLE) != 0:
...
np.savetxt('brown_mask.txt', brown_mask, fmt='%d')
